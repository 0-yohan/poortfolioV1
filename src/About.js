...
import me from "./assets/me_black_kurta.jpg"
        ...
        <div className="flex flex-col md:flex-row items-center md:space-x-8 mt-32">
          ...
          <div className="md:w-1/2 pl-4 text-center md:text-left">
            ...
            <a
              ...
              href="https://docs.google.com/document/d/1z6Hm7tkgsGSQSUiV6uKY07p3QmGxJjTp/edit"  // Replace with the actual path to your resume
              download="Resume.pdf"
